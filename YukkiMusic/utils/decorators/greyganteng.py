# @greyyvbss
# grey bosen ngebot masseh angjay
    ...
    async def wrapper(_, message: Message):
        ...
        try:
            try:
                ...
                try:
                    await message.reply(
                        f"**Hallo {rpk}. Agar Bisa Menggunakan Bot Anda Harus Masuk Ke Channel Terlebih Dahulu!. Silahkan Klik Tombol Di Bawah Untuk Join Ke Channel.**",
